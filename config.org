...
#+BEGIN_SRC  emacs-lisp
  ...
  (setq rcirc-default-user-name secrets-irc-freenode-user)
  (setq rcirc-default-full-name secrets-irc-freenode-user)
#+END_SRC
...
Agenda view, bindings used especially in this context.
