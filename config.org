...
Since version 9.2 `<s TAB` does not trigger the `#+BEGIN_SRC` block. The following fix is taken from an issue [disussion](https://github.com/syl20bnr/spacemacs/issues/11798#issuecomment-456754071).
